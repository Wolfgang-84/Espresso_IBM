...
/*************** REQ_SET_Sequence *************/
void mpi_set_sequ(int sequ_s) {
    mpi_call(mpi_set_sequ_slave, -1, 0);
    sequ = sequ_s;
    
    MPI_Bcast(&sequ, 1, MPI_INT, 0, comm_cart);
}

void mpi_set_sequ_slave(int node, int i) {
    MPI_Bcast(&sequ, 1, MPI_INT, 0, comm_cart);
}
